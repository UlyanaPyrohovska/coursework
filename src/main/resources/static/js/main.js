  ...
  $.fn.extend({
    treed: function (o) {
      ...
      if (typeof o != 'undefined'){
        ...
        var tree = $(this);
        tree.addClass("tree");
        var first = document.getElementById("loaded");
        setTimeout(function() {
            first.click();
        },10);
        tree.find('li').has("ul").each(function () {
            ...
            // var icon = first.children('i:first');
            // icon.toggleClass(openedClass + " " + closedClass);
            // first.children().children().toggle();
...
$("th input[type='checkbox']").on("change", function() {
    var cb = $(this),
        th = cb.parent(),
        col = th.index() + 1;
    $("tbody td:nth-child(" + col + ") input").prop("checked", this.checked);
});
